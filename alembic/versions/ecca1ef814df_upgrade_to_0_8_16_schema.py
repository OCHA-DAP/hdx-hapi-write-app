...
def upgrade() -> None:
    population_group_enum = ENUM(name='populationgroup', create_type=False)
    gender_enum = ENUM(name='gender', create_type=False)
    ...
    sa.Column('population_group', population_group_enum, nullable=False),
